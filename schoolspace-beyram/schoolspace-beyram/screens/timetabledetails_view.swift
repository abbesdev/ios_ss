...
struct timetabledetails_view: View {
    ...
    func addClass() {
        // Construct the URL
        let url = URL(string: "http://\(api.baseurl):8080/timetable")!
    ...
    func getClasses() {
        guard let url = URL(string: "http://\(api.baseurl):8080/class") else {
            print("Invalid URL")
            return
        }
    ...
    func getSubjects() {
        guard let url = URL(string: "http://\(api.baseurl):8080/subject") else {
            print("Invalid URL")
            return
        }
