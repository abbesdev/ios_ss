...
//  schoolspace-beyram
//
//  Created by Mac Mini 7 on 26/4/2023.
//
        ...
        VStack(alignment: .leading) {
            ...
            ScrollView {
                ForEach(students) { student in
                    if (selectedTabIndex == 0 && student.verified && student.userRole == "student")
                    {
                        ListViewCell2(name: "\(student.firstName) \(student.lastName)", email: student.email, number:"#\(student.registrationCode)", _id : student._id)
                       

                            
                    }else if (selectedTabIndex == 1 && !student.verified && student.userRole == "student"){
                        ListViewCell2(name: "\(student.firstName) \(student.lastName)", email: student.email, number:"#\(student.registrationCode)", _id : student._id)
